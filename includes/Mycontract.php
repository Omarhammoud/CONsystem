                    ...
                    while ($row = $result -> fetch_assoc()){
                        if($_SESSION["MemberID"] == $row["MemberID"]){
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-outline-warning" href="EditContract.inc.php?ContractID1=<?php echo $row["ContractID"];?>">Edit Contract</a></td>
                                <td><a class="btn btn-outline-danger" href="DeleteContract.inc.php?ContractID1=<?php echo  $row["ContractID"];?>">Delete Contract</a></td>
                            </tr>
                            <?php
                        }
                    }
